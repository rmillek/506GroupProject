...
- Disvriminant Analysis (using "discrim" function):
...
There are three groups which indicates that the maximum discriminant dimensions is 2. The two discriminant dimensions are both statistically significant based on the table above (P values of the F-tests are very small). As a result, both dimensions are very useful to describe the differences between the groups of seeds. The canonical correlations for the two dimensions are 0.93 and 0.87.
