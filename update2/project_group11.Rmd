...
Linear Discriminant Analysis (LDA) is commonly used as dimensionality reduction technique in the pre-processing step for pattern-classification and machine learning applications. The goal of LDA is to find discriminant functions that are the linear combination of independent continuous variables that will group two or more categories of the dependent variable the in best possible way. It helps one to examine whether significant differences exist among the groups, in terms of the independent variables. It also evaluates how accurate the process of the classification is.
...
table_data = data.frame(var_names = c(1,2,3,4,5,6,7),
                       ...
                       var_ff = c("Area", "Perimeter","Compactness (C = 4*pi*A/P^2)",
