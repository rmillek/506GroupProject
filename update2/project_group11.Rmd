...
We want to find the linear combinations of the variables which can provide the best possible separation to the three levels in the variable `group`. In finding how many conbinations are needed to best differentiate our classifications, we take the number of groups and variables into account. The number of groups is $G=3$, and the number of variables is $v=7$. The greatest amouont of useful discriminant functions that can separate the wheat types by geometric properties is the lesser of $G-1$ and $v$. In this case it is the lesser of 2 and 7, so we should find 2 useful discriminant functions to classify our wheat types.
