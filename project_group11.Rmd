...
Group 1 is Kama; Group 2 is Rose; Group 3 is Canadian.
...
- Analysis (using "discrim" function):
...
There are three groups which indicates that the maximum discriminant dimensions is 2. The two discriminant dimensions are both statistically significant based on the table above (P values of the F-tests are very small). The canonical correlations for the two dimensions 0.93 and 0.87.
